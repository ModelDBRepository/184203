'''
Current clamp demo using Allen Brain's model 472427533.
...
from neuron472427533 import Neuron472427533
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron472427533(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 472427533; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-92.7820739746)
        h.fcurrent()
